...
import "../../assets/styles/lostcivilaization/lost_civilaizationtop.css";
import bgImage from "../../assets/images/lostcivilaization/island-bg.jpg"; // Import the image

const LostCivilizationTop = () => {
	return (
		<div
...
export default LostCivilizationTop;
